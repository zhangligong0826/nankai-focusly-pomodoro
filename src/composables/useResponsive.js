...
/**
 * 响应式组合式函数
 * @returns {{ breakpoint: import('vue').Ref<string>, isMobile: import('vue').ComputedRef<boolean>, isTablet: import('vue').ComputedRef<boolean>, isPC: import('vue').ComputedRef<boolean> }}
 */
export function useResponsive() {
  const breakpoint = ref('pc')
